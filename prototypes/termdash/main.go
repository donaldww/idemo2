...
func main() {
	...
	// TODO: Either implement quit using q or else change the documentation.
...
func newSegmentDisplay(ctx context.Context,
	updateText <-chan string) (*segmentdisplay.SegmentDisplay, error) {
